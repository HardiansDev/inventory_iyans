...
@section('content')
    ...
    <section class="mb-6 rounded-lg bg-white p-6 shadow-sm">
        <div class="mx-auto flex max-w-7xl flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Manajemen Departemen</h1>
                <p class="mt-1 text-sm text-gray-500">Kelola data departemen pegawai di sistem Anda</p>
            </div>
        </div>
    </section>
    ...
    <div id="departmentModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
        <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-lg font-semibold text-gray-800">Tambah Departemen</h2>
    ...
    <div id="editDepartmentModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
        <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-lg font-semibold text-gray-800">Edit Departemen</h2>
            <form id="editDepartmentForm" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-4">
                    <label for="editDepartmentName" class="block text-sm font-medium text-gray-700">Nama Departemen</label>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
        <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            ...
            <p class="mb-6 text-gray-700">Yakin ingin menghapus departemen <span id="departmentName"
