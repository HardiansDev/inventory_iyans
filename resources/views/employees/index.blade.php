...
@section('content')
    ...
    <form method="GET" action="{{ route('employees.index') }}" class="mb-6">
        <div class="grid grid-cols-1 gap-4 rounded-lg bg-white p-6 shadow sm:grid-cols-2 lg:grid-cols-6">
            <!-- Departemen -->
            ...
            <!-- Posisi -->
            <div class="col-span-1">
                <label for="position" class="mb-1 block text-sm font-medium text-gray-700">Posisi</label>
            ...
            <!-- Search -->
            <div class="col-span-1">
                <label for="search" class="mb-1 block text-sm font-medium text-gray-700">Cari Pegawai</label>
            ...
            <div class="col-span-2 flex items-end justify-start gap-2">
                ...
                <a href="{{ route('employees.index') }}"
                    class="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-100">
                    Reset
                </a>
            </div>
        </div>
    ...
    <div class="rounded-lg bg-white p-6 shadow-sm">
        ...
        <div class="overflow-x-auto overflow-y-visible rounded-lg border border-gray-200 shadow">
