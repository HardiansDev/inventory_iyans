        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if (Auth::user()->role === 'superadmin')
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('product.index') }}"><i class="fa fa-circle-o"></i> List Data Product</a>
                        </li>
                        <li><a href="{{ route('product.create') }}"><i class="fa fa-circle-o"></i> Tambah Product</a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            @if (Auth::user()->role === 'kasir')
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('customer.index') }}"><i class="fa fa-circle-o"></i> List Data
                                Customer</a></li>
            ...
            {{-- Admin Gudang: Produk, PIC, Category, Supplier, Product In/Out --}}
